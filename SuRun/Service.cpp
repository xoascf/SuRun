          ...
          CREATE_SUSPENDED|CREATE_UNICODE_ENVIRONMENT,Env,g_RunData.CurDir,&si,&pi))
      {
        ...
        if(bIsExplorer)
        {
          ...
          if (_winmajor<6)
          {
            ...
            //Explorer to open folders in a new process
...
#define CPLREG  L"CLSID\\{21EC2020-3AEA-1069-A2DD-08002B30309D}"  SHLRUN //Control Panel
#define TRSREG  L"CLSID\\{645FF040-5081-101B-9F08-00AA002F954E}"  SHLRUN //Recycle Bin
